Public Class Form1
    ...
    Private Sub btnConvertirMasa_Click(sender As Object, e As EventArgs) Handles btnConvertirMasa.Click
        ...
        Select Case cboMasa1.SelectedIndex
            Case 1 'tonelada a
                If cboMasa2.SelectedIndex = 1 Then 'Tonelada
                    Valor = Cant * 1
                    txtResultadoMasa.Text = Math.Round(Valor, 2)
                End If
                If cboMasa2.SelectedIndex = 2 Then 'Tonelada larga 
                    Valor = Cant * 0.984207
                    txtResultadoMasa.Text = Math.Round(Valor, 2)
                End If
                If cboMasa2.SelectedIndex = 3 Then 'Tonelada corta
                    Valor = Cant * 1.10231
                    txtResultadoMasa.Text = Math.Round(Valor, 2)
                End If
                If cboMasa2.SelectedIndex = 4 Then 'Stone
                    Valor = Cant * 157.473
                    txtResultadoMasa.Text = Math.Round(Valor, 2)
                End If
                If cboMasa2.SelectedIndex = 5 Then 'Onza
                    Valor = Cant * 35274
                    txtResultadoMasa.Text = Math.Round(Valor, 2)
                End If
                If cboMasa2.SelectedIndex = 6 Then 'Kilograma
                    Valor = Cant * 1000
                    txtResultadoMasa.Text = Math.Round(Valor, 2)
                End If
                If cboMasa2.SelectedIndex = 7 Then 'Libra
                    Valor = Cant * 2204.62
                    txtResultadoMasa.Text = Math.Round(Valor, 2)
                End If
                If cboMasa2.SelectedIndex = 8 Then 'Gramo  
                    Valor = Cant * 1000000.0
                    txtResultadoMasa.Text = Math.Round(Valor, 2)
                End If
                If cboMasa2.SelectedIndex = 9 Then 'Miligramo
                    Valor = Cant * 1000000000.0
                    txtResultadoMasa.Text = Math.Round(Valor, 2)
                End If
                If cboMasa2.SelectedIndex = 10 Then 'Microgramo
